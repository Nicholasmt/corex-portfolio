          ...
          <div class="col-3 sidebar-bg">
            <div class="d-flex align-items-start">
              <div class="nav flex-column nav-pills text-left" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <button wire:click="portfolio" class="nav-link mt-2 @if($current == 3) active @endif" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="bi bi-card-image"></i> <span class="nav-text">Portfolios</span></button>
                <button wire:click="about" class="nav-link mt-2 @if($current == 5) active @endif" id="v-pills-about-tab" data-bs-toggle="pill" data-bs-target="#v-pills-about" type="button" role="tab" aria-controls="v-pills-about" aria-selected="false"><i class="bi bi-card-image"></i> <span class="nav-text">About</span></button>
                <button wire:click="education" class="nav-link mt-2 @if($current == 6) active @endif" id="v-pills-education-tab" data-bs-toggle="pill" data-bs-target="#v-pills-education" type="button" role="tab" aria-controls="v-pills-education" aria-selected="false"><i class="bi bi-card-image"></i> <span class="nav-text">Education</span></button>
                <button wire:click="experience" class="nav-link mt-2 @if($current == 7) active @endif" id="v-pills-experience-tab" data-bs-toggle="pill" data-bs-target="#v-pills-experience" type="button" role="tab" aria-controls="v-pills-experience" aria-selected="false"><i class="bi bi-card-image"></i> <span class="nav-text">Experiences</span></button>
                <button wire:click="social" class="nav-link mt-2 @if($current == 8) active @endif" id="v-pills-social-tab" data-bs-toggle="pill" data-bs-target="#v-pills-social" type="button" role="tab" aria-controls="v-pills-socials" aria-selected="false"><i class="bi bi-card-image"></i> <span class="nav-text">Socials</span></button>
