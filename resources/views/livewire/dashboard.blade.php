          ...
          <div class="col-3 sidebar-bg">
            <div class="d-flex align-items-start">
              <div class="nav flex-column nav-pills text-left" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <button wire:click="about" class="nav-link mt-2 @if($current == 3) active @endif" id="v-pills-about-tab" data-bs-toggle="pill" data-bs-target="#v-pills-about" type="button" role="tab" aria-controls="v-pills-about" aria-selected="false"><i class="bi bi-card-image"></i> About</button>
                <button wire:click="education" class="nav-link mt-2 @if($current == 3) active @endif" id="v-pills-education-tab" data-bs-toggle="pill" data-bs-target="#v-pills-education" type="button" role="tab" aria-controls="v-pills-education" aria-selected="false"><i class="bi bi-card-image"></i> Educations</button>
                <button wire:click="experience" class="nav-link mt-2 @if($current == 3) active @endif" id="v-pills-experience-tab" data-bs-toggle="pill" data-bs-target="#v-pills-experience" type="button" role="tab" aria-controls="v-pills-experience" aria-selected="false"><i class="bi bi-card-image"></i> Experiences</button>
                <button wire:click="social" class="nav-link mt-2 @if($current == 3) active @endif" id="v-pills-social-tab" data-bs-toggle="pill" data-bs-target="#v-pills-social" type="button" role="tab" aria-controls="v-pills-socials" aria-selected="false"><i class="bi bi-card-image"></i> Socials</button>
         ...
         <div class="col-9">
           <div class="tab-content" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade @if($current == 2) show active  @endif" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                ...
                {{-- about --}}
                <div class="tab-pane fade  @if($current == 3) show active @endif" id="v-pills-about" role="tabpanel" aria-labelledby="v-pills-about-tab">
                    @include('back.about') 
                </div> 
                 {{-- education --}}
                <div class="tab-pane fade  @if($current == 3) show active @endif" id="v-pills-education" role="tabpanel" aria-labelledby="v-pills-education-tab">
                    @include('back.educations') 
                </div> 
                 {{-- experience --}}
                <div class="tab-pane fade  @if($current == 3) show active @endif" id="v-pills-experience" role="tabpanel" aria-labelledby="v-pills-experience-tab">
                    @include('back.experiences') 
                </div> 
                {{-- social --}}
                <div class="tab-pane fade  @if($current == 3) show active @endif" id="v-pills-social" role="tabpanel" aria-labelledby="v-pills-social-tab">
